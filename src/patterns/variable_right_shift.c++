...
class variable_right_shift: public libcgraph::pattern {
private:
...
public:
    variable_right_shift(size_t _in_w, size_t _out_w, size_t _offset_w)
...
class variable_right_shift_factory: public libcgraph::pattern_factory {
    typedef std::shared_ptr<libcgraph::pattern> pattern_ptr;

    const std::string name(void) const
        {
            return "variable_right_shift";
        }
    ...
    const pattern_ptr create(const std::string& args) const
        {
            ...
            return std::make_shared<variable_right_shift>(iw, ow, tw);
        }
...
void cons(void)
{
    auto factory = std::make_shared<variable_right_shift_factory>();
